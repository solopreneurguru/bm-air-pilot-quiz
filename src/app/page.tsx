    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">
          Welcome to BM Air Pilot Quiz
        </h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Professional pilot assessment and training platform designed to enhance your aviation knowledge and skills.
        </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Test your knowledge across all aviation domains</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Get immediate results and detailed explanations</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Access comprehensive learning materials</p>
          </div>
        </div>
      </div>
    </div>
